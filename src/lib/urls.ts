...
const ADMIN_AGENT_URL = "https://admin-agent-667915768397.europe-west1.run.app"
...
export const DESCRIPTION_URL = `${ADMIN_AGENT_URL}/product-description`;
export const CHAT_URL = `${ADMIN_AGENT_URL}/chat`;
